...
# Be sure not to forget the slash (Windows: backslash, OSX: forward slash)  at the end of the directory name.
	sentence Directory XXX/targets-stereo
	#sentence Word 
...
Create Strings as file list... file-list 'directory$'/*.'filetype$'
...
printline TextGrids have been created for .'filetype$' files in 
printline 'directory$'